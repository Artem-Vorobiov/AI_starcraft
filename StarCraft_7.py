...
class SentdeBot(sc2.BotAI):
    ...
    async def intel(self):
        ...
        print('\n', '\t game_info.map_size')        #   (200, 176)
        print(self.game_info.map_size)
        print('\n', '\t TYPE game_info.map_size')   #   <class 'sc2.position.Size'>       
        print(type(self.game_info.map_size))
        # flip around. It's y, x when you're dealing with an array.

        # Создал массив данных состоящий из нулей, формы - (2,3). При этом 2 состоит из 2 массивов
        ...
        for nexus in self.units(NEXUS):
            ...
            print('\n', '\t position')              #   (161.5, 21.5)
            print(nex_pos)
            print('\n', '\t TYPE position')         #   <class 'sc2.position.Point2'>
            print(type(nex_pos))
        ...
        #   Увеличивает размер карты в 2 раза
